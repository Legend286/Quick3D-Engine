...
public struct ScenePushData
{
    ...
    // Phase-3 DDGI atlas + probe grid plumbing. Populated by PbrPass
    // when the host's RendererPluginContext exposes a DDGI atlas. The
    ...
    public Vector4 DDGISpecularParams;
    ...
    public ulong DDGIProbeSpecularStates;
}
